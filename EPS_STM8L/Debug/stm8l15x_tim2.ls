 ...
 503                     ; 321   TIM2->CR1 = tmpcr1;
 505  00b0 7b01          	ld	a,(OFST+0,sp)
 506  00b2 c75250        	ld	21072,a
 507                     ; 322 }
 510  00b5 85            	popw	x
 511  00b6 81            	ret
 545                     ; 330 void TIM2_SetCounter(uint16_t Counter)
 545                     ; 331 {
 546                     	switch	.text
 547  00b7               _TIM2_SetCounter:
 551                     ; 334   TIM2->CNTRH = (uint8_t)(Counter >> 8);
 553  00b7 9e            	ld	a,xh
 554  00b8 c7525c        	ld	21084,a
 555                     ; 335   TIM2->CNTRL = (uint8_t)(Counter);
 557  00bb 9f            	ld	a,xl
 558  00bc c7525d        	ld	21085,a
 559                     ; 336 }
 562  00bf 81            	ret
 596                     ; 344 void TIM2_SetAutoreload(uint16_t Autoreload)
 596                     ; 345 {
 597                     	switch	.text
 598  00c0               _TIM2_SetAutoreload:
 602                     ; 347   TIM2->ARRH = (uint8_t)(Autoreload >> 8);
 604  00c0 9e            	ld	a,xh
 605  00c1 c7525f        	ld	21087,a
 606                     ; 348   TIM2->ARRL = (uint8_t)(Autoreload);
 608  00c4 9f            	ld	a,xl
 609  00c5 c75260        	ld	21088,a
 610                     ; 349 }
 613  00c8 81            	ret
 665                     ; 356 uint16_t TIM2_GetCounter(void)
 665                     ; 357 {
 666                     	switch	.text
 ...
 675                     ; 361   tmpcntrh = TIM2->CNTRH;
 677  00cb c6525c        	ld	a,21084
 678  00ce 6b02          	ld	(OFST-2,sp),a
 679                     ; 362   tmpcntrl = TIM2->CNTRL;
 ...
 708  00ee 81            	ret
 732                     ; 383 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
 732                     ; 384 {
 733                     	switch	.text
 734  00ef               _TIM2_GetPrescaler:
 738                     ; 386   return ((TIM2_Prescaler_TypeDef)TIM2->PSCR);
 740  00ef c6525e        	ld	a,21086
 743  00f2 81            	ret
 799                     ; 396 void TIM2_UpdateDisableConfig(FunctionalState NewState)
 799                     ; 397 {
 800                     	switch	.text
 ...
 811                     ; 404     TIM2->CR1 |= TIM_CR1_UDIS;
 813  00f6 72125250      	bset	21072,#1
 815  00fa 2004          	jra	L713
 816  00fc               L513:
 817                     ; 408     TIM2->CR1 &= (uint8_t)(~TIM_CR1_UDIS);
 819  00fc 72135250      	bres	21072,#1
 820  0100               L713:
 821                     ; 410 }
 824  0100 81            	ret
 882                     ; 420 void TIM2_UpdateRequestConfig(TIM2_UpdateSource_TypeDef TIM2_UpdateSource)
 882                     ; 421 {
 883                     	switch	.text
 884  0101               _TIM2_UpdateRequestConfig:
 888                     ; 423   assert_param(IS_TIM2_UPDATE_SOURCE(TIM2_UpdateSource));
 890                     ; 426   if (TIM2_UpdateSource == TIM2_UpdateSource_Regular)
 892  0101 a101          	cp	a,#1
 893  0103 2606          	jrne	L743
 894                     ; 428     TIM2->CR1 |= TIM_CR1_URS ;
 896  0105 72145250      	bset	21072,#2
 898  0109 2004          	jra	L153
 899  010b               L743:
 900                     ; 432     TIM2->CR1 &= (uint8_t)(~TIM_CR1_URS);
 902  010b 72155250      	bres	21072,#2
 903  010f               L153:
 904                     ; 434 }
 907  010f 81            	ret
 943                     ; 442 void TIM2_ARRPreloadConfig(FunctionalState NewState)
 943                     ; 443 {
 944                     	switch	.text
 ...
 955                     ; 450     TIM2->CR1 |= TIM_CR1_ARPE;
 957  0113 721e5250      	bset	21072,#7
 959  0117 2004          	jra	L373
 960  0119               L173:
 961                     ; 454     TIM2->CR1 &= (uint8_t)(~TIM_CR1_ARPE);
 963  0119 721f5250      	bres	21072,#7
 964  011d               L373:
 965                     ; 456 }
 968  011d 81            	ret
1025                     ; 466 void TIM2_SelectOnePulseMode(TIM2_OPMode_TypeDef TIM2_OPMode)
1025                     ; 467 {
1026                     	switch	.text
1027  011e               _TIM2_SelectOnePulseMode:
1031                     ; 469   assert_param(IS_TIM2_OPM_MODE(TIM2_OPMode));
1033                     ; 472   if (TIM2_OPMode == TIM2_OPMode_Single)
1035  011e a101          	cp	a,#1
1036  0120 2606          	jrne	L324
1037                     ; 474     TIM2->CR1 |= TIM_CR1_OPM ;
1039  0122 72165250      	bset	21072,#3
1041  0126 2004          	jra	L524
1042  0128               L324:
1043                     ; 478     TIM2->CR1 &= (uint8_t)(~TIM_CR1_OPM);
1045  0128 72175250      	bres	21072,#3
1046  012c               L524:
1047                     ; 480 }
1050  012c 81            	ret
1085                     ; 488 void TIM2_Cmd(FunctionalState NewState)
1085                     ; 489 {
1086                     	switch	.text
1087  012d               _TIM2_Cmd:
...
1097                     ; 496     TIM2->CR1 |= TIM_CR1_CEN;
1099  0130 72105250      	bset	21072,#0
1101  0134 2004          	jra	L744
1102  0136               L544:
1103                     ; 500     TIM2->CR1 &= (uint8_t)(~TIM_CR1_CEN);
1105  0136 72115250      	bres	21072,#0
1106  013a               L744:
1107                     ; 502 }
1110  013a 81            	ret
1308                     ; 578 void TIM2_OC1Init(TIM2_OCMode_TypeDef TIM2_OCMode,
1308                     ; 579                   TIM2_OutputState_TypeDef TIM2_OutputState,
1308                     ; 580                   uint16_t TIM2_Pulse,
1308                     ; 581                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity,
1308                     ; 582                   TIM2_OCIdleState_TypeDef TIM2_OCIdleState)
1308                     ; 583 {
1309                     	switch	.text
...
1319                     ; 587   assert_param(IS_TIM2_OC_MODE(TIM2_OCMode));
1321                     ; 588   assert_param(IS_TIM2_OUTPUT_STATE(TIM2_OutputState));
1323                     ; 589   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
1325                     ; 590   assert_param(IS_TIM2_OCIDLE_STATE(TIM2_OCIdleState));
1327                     ; 592   tmpccmr1 = TIM2->CCMR1;
1329  013d c65259        	ld	a,21081
1330  0140 6b01          	ld	(OFST+0,sp),a
1331                     ; 595   TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
...
1339                     ; 600   tmpccmr1 |= (uint8_t)TIM2_OCMode;
1341  014c 9e            	ld	a,xh
1342  014d 1a01          	or	a,(OFST+0,sp)
1343  014f 6b01          	ld	(OFST+0,sp),a
1344                     ; 602   TIM2->CCMR1 = tmpccmr1;
1346  0151 7b01          	ld	a,(OFST+0,sp)
1347  0153 c75259        	ld	21081,a
1348                     ; 605   if (TIM2_OutputState == TIM2_OutputState_Enable)
1350  0156 9f            	ld	a,xl
1351  0157 a101          	cp	a,#1
1352  0159 2606          	jrne	L365
1353                     ; 607     TIM2->CCER1 |= TIM_CCER1_CC1E;
1355  015b 7210525b      	bset	21083,#0
1357  015f 2004          	jra	L565
1358  0161               L365:
1359                     ; 611     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1361  0161 7211525b      	bres	21083,#0
1362  0165               L565:
1363                     ; 615   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
1365  0165 7b08          	ld	a,(OFST+7,sp)
1366  0167 a101          	cp	a,#1
1367  0169 2606          	jrne	L765
1368                     ; 617     TIM2->CCER1 |= TIM_CCER1_CC1P;
1370  016b 7212525b      	bset	21083,#1
1372  016f 2004          	jra	L175
1373  0171               L765:
1374                     ; 621     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
1376  0171 7213525b      	bres	21083,#1
1377  0175               L175:
1378                     ; 625   if (TIM2_OCIdleState == TIM2_OCIdleState_Set)
1380  0175 7b09          	ld	a,(OFST+8,sp)
1381  0177 a101          	cp	a,#1
1382  0179 2606          	jrne	L375
1383                     ; 627     TIM2->OISR |= TIM_OISR_OIS1;
1385  017b 72105266      	bset	21094,#0
1387  017f 2004          	jra	L575
1388  0181               L375:
1389                     ; 631     TIM2->OISR &= (uint8_t)(~TIM_OISR_OIS1);
1391  0181 72115266      	bres	21094,#0
1392  0185               L575:
1393                     ; 635   TIM2->CCR1H = (uint8_t)(TIM2_Pulse >> 8);
1395  0185 7b06          	ld	a,(OFST+5,sp)
1396  0187 c75261        	ld	21089,a
1397                     ; 636   TIM2->CCR1L = (uint8_t)(TIM2_Pulse);
1399  018a 7b07          	ld	a,(OFST+6,sp)
1400  018c c75262        	ld	21090,a
1401                     ; 637 }
1404  018f 5b03          	addw	sp,#3
1405  0191 81            	ret
1488                     ; 664 void TIM2_OC2Init(TIM2_OCMode_TypeDef TIM2_OCMode,
1488                     ; 665                   TIM2_OutputState_TypeDef TIM2_OutputState,
1488                     ; 666                   uint16_t TIM2_Pulse,
1488                     ; 667                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity,
1488                     ; 668                   TIM2_OCIdleState_TypeDef TIM2_OCIdleState)
1488                     ; 669 {
1489                     	switch	.text
...
1499                     ; 673   assert_param(IS_TIM2_OC_MODE(TIM2_OCMode));
1501                     ; 674   assert_param(IS_TIM2_OUTPUT_STATE(TIM2_OutputState));
1503                     ; 675   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
1505                     ; 676   assert_param(IS_TIM2_OCIDLE_STATE(TIM2_OCIdleState));
1507                     ; 678   tmpccmr2 = TIM2->CCMR2;
1509  0194 c6525a        	ld	a,21082
1510  0197 6b01          	ld	(OFST+0,sp),a
1511                     ; 681   TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
...
1519                     ; 687   tmpccmr2 |= (uint8_t)TIM2_OCMode;
1521  01a3 9e            	ld	a,xh
1522  01a4 1a01          	or	a,(OFST+0,sp)
1523  01a6 6b01          	ld	(OFST+0,sp),a
1524                     ; 689   TIM2->CCMR2 = tmpccmr2;
1526  01a8 7b01          	ld	a,(OFST+0,sp)
1527  01aa c7525a        	ld	21082,a
1528                     ; 692   if (TIM2_OutputState == TIM2_OutputState_Enable)
1530  01ad 9f            	ld	a,xl
1531  01ae a101          	cp	a,#1
1532  01b0 2606          	jrne	L146
1533                     ; 694     TIM2->CCER1 |= TIM_CCER1_CC2E;
1535  01b2 7218525b      	bset	21083,#4
1537  01b6 2004          	jra	L346
1538  01b8               L146:
1539                     ; 698     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1541  01b8 7219525b      	bres	21083,#4
1542  01bc               L346:
1543                     ; 702   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
1545  01bc 7b08          	ld	a,(OFST+7,sp)
1546  01be a101          	cp	a,#1
1547  01c0 2606          	jrne	L546
1548                     ; 704     TIM2->CCER1 |= TIM_CCER1_CC2P;
1550  01c2 721a525b      	bset	21083,#5
1552  01c6 2004          	jra	L746
1553  01c8               L546:
1554                     ; 708     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P);
1556  01c8 721b525b      	bres	21083,#5
1557  01cc               L746:
1558                     ; 713   if (TIM2_OCIdleState == TIM2_OCIdleState_Set)
1560  01cc 7b09          	ld	a,(OFST+8,sp)
1561  01ce a101          	cp	a,#1
1562  01d0 2606          	jrne	L156
1563                     ; 715     TIM2->OISR |= TIM_OISR_OIS2;
1565  01d2 72145266      	bset	21094,#2
1567  01d6 2004          	jra	L356
1568  01d8               L156:
1569                     ; 719     TIM2->OISR &= (uint8_t)(~TIM_OISR_OIS2);
1571  01d8 72155266      	bres	21094,#2
1572  01dc               L356:
1573                     ; 723   TIM2->CCR2H = (uint8_t)(TIM2_Pulse >> 8);
1575  01dc 7b06          	ld	a,(OFST+5,sp)
1576  01de c75263        	ld	21091,a
1577                     ; 724   TIM2->CCR2L = (uint8_t)(TIM2_Pulse);
1579  01e1 7b07          	ld	a,(OFST+6,sp)
1580  01e3 c75264        	ld	21092,a
1581                     ; 725 }
1584  01e6 5b03          	addw	sp,#3
1585  01e8 81            	ret
1783                     ; 754 void TIM2_BKRConfig(TIM2_OSSIState_TypeDef TIM2_OSSIState,
1783                     ; 755                     TIM2_LockLevel_TypeDef TIM2_LockLevel,
1783                     ; 756                     TIM2_BreakState_TypeDef TIM2_BreakState,
1783                     ; 757                     TIM2_BreakPolarity_TypeDef TIM2_BreakPolarity,
1783                     ; 758                     TIM2_AutomaticOutput_TypeDef TIM2_AutomaticOutput)
1783                     ; 759 
1783                     ; 760 {
1784                     	switch	.text
...
1792                     ; 762   assert_param(IS_TIM2_OSSI_STATE(TIM2_OSSIState));
1794                     ; 763   assert_param(IS_TIM2_LOCK_LEVEL(TIM2_LockLevel));
1796                     ; 764   assert_param(IS_TIM2_BREAK_STATE(TIM2_BreakState));
1798                     ; 765   assert_param(IS_TIM2_BREAK_POLARITY(TIM2_BreakPolarity));
1800                     ; 766   assert_param(IS_TIM2_AUTOMATIC_OUTPUT_STATE(TIM2_AutomaticOutput));
1802                     ; 772   TIM2->BKR = (uint8_t)((uint8_t)((uint8_t)((uint8_t)((uint8_t)TIM2_OSSIState | (uint8_t)TIM2_LockLevel) | \
1802                     ; 773                                   (uint8_t)((uint8_t)TIM2_BreakState | (uint8_t)TIM2_BreakPolarity)) | \
1802                     ; 774                                   TIM2_AutomaticOutput));
...
1816  01fd 81            	ret
1852                     ; 783 void TIM2_CtrlPWMOutputs(FunctionalState NewState)
1852                     ; 784 {
1853                     	switch	.text
...
1864                     ; 792     TIM2->BKR |= TIM_BKR_MOE ;
1866  0201 721e5265      	bset	21093,#7
1868  0205 2004          	jra	L7001
1869  0207               L5001:
1870                     ; 796     TIM2->BKR &= (uint8_t)(~TIM_BKR_MOE) ;
1872  0207 721f5265      	bres	21093,#7
1873  020b               L7001:
1874                     ; 798 }
1877  020b 81            	ret
1942                     ; 818 void TIM2_SelectOCxM(TIM2_Channel_TypeDef TIM2_Channel,
1942                     ; 819                      TIM2_OCMode_TypeDef TIM2_OCMode)
1942                     ; 820 {
1943                     	switch	.text
1944  020c               _TIM2_SelectOCxM:
1946  020c 89            	pushw	x
1947       00000000      OFST:	set	0
1950                     ; 822   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
1952                     ; 823   assert_param(IS_TIM2_OCM(TIM2_OCMode));
1954                     ; 825   if (TIM2_Channel == TIM2_Channel_1)
1956  020d 9e            	ld	a,xh
1957  020e 4d            	tnz	a
1958  020f 2615          	jrne	L3401
1959                     ; 828     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1961  0211 7211525b      	bres	21083,#0
1962                     ; 831     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCM);
1964  0215 c65259        	ld	a,21081
1965  0218 a48f          	and	a,#143
1966  021a c75259        	ld	21081,a
1967                     ; 834     TIM2->CCMR1 |= (uint8_t)TIM2_OCMode;
1969  021d 9f            	ld	a,xl
1970  021e ca5259        	or	a,21081
1971  0221 c75259        	ld	21081,a
1973  0224 2014          	jra	L5401
1974  0226               L3401:
1975                     ; 839     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1977  0226 7219525b      	bres	21083,#4
1978                     ; 842     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCM);
1980  022a c6525a        	ld	a,21082
1981  022d a48f          	and	a,#143
1982  022f c7525a        	ld	21082,a
1983                     ; 845     TIM2->CCMR2 |= (uint8_t)TIM2_OCMode;
...
1992  023a 85            	popw	x
1993  023b 81            	ret
2027                     ; 855 void TIM2_SetCompare1(uint16_t Compare)
2027                     ; 856 {
2028                     	switch	.text
2029  023c               _TIM2_SetCompare1:
2033                     ; 858   TIM2->CCR1H = (uint8_t)(Compare >> 8);
2035  023c 9e            	ld	a,xh
2036  023d c75261        	ld	21089,a
2037                     ; 859   TIM2->CCR1L = (uint8_t)(Compare);
2039  0240 9f            	ld	a,xl
2040  0241 c75262        	ld	21090,a
2041                     ; 860 }
2044  0244 81            	ret
2078                     ; 868 void TIM2_SetCompare2(uint16_t Compare)
2078                     ; 869 {
2079                     	switch	.text
2080  0245               _TIM2_SetCompare2:
2084                     ; 871   TIM2->CCR2H = (uint8_t)(Compare >> 8);
2086  0245 9e            	ld	a,xh
2087  0246 c75263        	ld	21091,a
2088                     ; 872   TIM2->CCR2L = (uint8_t)(Compare);
2090  0249 9f            	ld	a,xl
2091  024a c75264        	ld	21092,a
2092                     ; 873 }
2095  024d 81            	ret
2162                     ; 883 void TIM2_ForcedOC1Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2162                     ; 884 {
2163                     	switch	.text
...
2173                     ; 888   assert_param(IS_TIM2_FORCED_ACTION(TIM2_ForcedAction));
2175                     ; 890   tmpccmr1 = TIM2->CCMR1;
...
2184                     ; 896   tmpccmr1 |= (uint8_t)TIM2_ForcedAction;
2186  025b 7b01          	ld	a,(OFST+0,sp)
2187  025d 1a02          	or	a,(OFST+1,sp)
2188  025f 6b01          	ld	(OFST+0,sp),a
2189                     ; 898   TIM2->CCMR1 = tmpccmr1;
2191  0261 7b01          	ld	a,(OFST+0,sp)
2192  0263 c75259        	ld	21081,a
2193                     ; 899 }
2196  0266 85            	popw	x
2197  0267 81            	ret
2242                     ; 909 void TIM2_ForcedOC2Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2242                     ; 910 {
2243                     	switch	.text
...
2253                     ; 914   assert_param(IS_TIM2_FORCED_ACTION(TIM2_ForcedAction));
2255                     ; 916   tmpccmr2 = TIM2->CCMR2;
...
2325                     ; 941     TIM2->CCMR1 |= TIM_CCMR_OCxPE ;
2327  0285 72165259      	bset	21081,#3
2329  0289 2004          	jra	L7711
2330  028b               L5711:
2331                     ; 945     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2333  028b 72175259      	bres	21081,#3
2334  028f               L7711:
2335                     ; 947 }
2338  028f 81            	ret
2374                     ; 955 void TIM2_OC2PreloadConfig(FunctionalState NewState)
2374                     ; 956 {
2375                     	switch	.text
...
2386                     ; 963     TIM2->CCMR2 |= TIM_CCMR_OCxPE ;
2388  0293 7216525a      	bset	21082,#3
2390  0297 2004          	jra	L1221
2391  0299               L7121:
2392                     ; 967     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2394  0299 7217525a      	bres	21082,#3
2395  029d               L1221:
2396                     ; 969 }
2399  029d 81            	ret
2434                     ; 977 void TIM2_OC1FastConfig(FunctionalState NewState)
2434                     ; 978 {
2435                     	switch	.text
...
2446                     ; 985     TIM2->CCMR1 |= TIM_CCMR_OCxFE ;
2448  02a1 72145259      	bset	21081,#2
2450  02a5 2004          	jra	L3421
2451  02a7               L1421:
2452                     ; 989     TIM2->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2454  02a7 72155259      	bres	21081,#2
2455  02ab               L3421:
2456                     ; 991 }
2459  02ab 81            	ret
2494                     ; 1000 void TIM2_OC2FastConfig(FunctionalState NewState)
2494                     ; 1001 {
2495                     	switch	.text
...
2506                     ; 1008     TIM2->CCMR2 |= TIM_CCMR_OCxFE ;
2508  02af 7214525a      	bset	21082,#2
2510  02b3 2004          	jra	L5621
2511  02b5               L3621:
2512                     ; 1012     TIM2->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2514  02b5 7215525a      	bres	21082,#2
2515  02b9               L5621:
2516                     ; 1014 }
2519  02b9 81            	ret
2555                     ; 1024 void TIM2_OC1PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
2555                     ; 1025 {
2556                     	switch	.text
2557  02ba               _TIM2_OC1PolarityConfig:
2561                     ; 1027   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
2563                     ; 1030   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
2565  02ba a101          	cp	a,#1
2566  02bc 2606          	jrne	L5031
2567                     ; 1032     TIM2->CCER1 |= TIM_CCER1_CC1P ;
2569  02be 7212525b      	bset	21083,#1
2571  02c2 2004          	jra	L7031
2572  02c4               L5031:
2573                     ; 1036     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P) ;
2575  02c4 7213525b      	bres	21083,#1
2576  02c8               L7031:
2577                     ; 1038 }
2580  02c8 81            	ret
2616                     ; 1048 void TIM2_OC2PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
2616                     ; 1049 {
2617                     	switch	.text
2618  02c9               _TIM2_OC2PolarityConfig:
2622                     ; 1051   assert_param(IS_TIM2_OC_POLARITY(TIM2_OCPolarity));
2624                     ; 1054   if (TIM2_OCPolarity == TIM2_OCPolarity_Low)
2626  02c9 a101          	cp	a,#1
2627  02cb 2606          	jrne	L7231
2628                     ; 1056     TIM2->CCER1 |= TIM_CCER1_CC2P ;
2630  02cd 721a525b      	bset	21083,#5
2632  02d1 2004          	jra	L1331
2633  02d3               L7231:
2634                     ; 1060     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
2636  02d3 721b525b      	bres	21083,#5
2637  02d7               L1331:
2638                     ; 1062 }
2641  02d7 81            	ret
2686                     ; 1074 void TIM2_CCxCmd(TIM2_Channel_TypeDef TIM2_Channel,
...
2694                     ; 1078   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
2696                     ; 1079   assert_param(IS_FUNCTIONAL_STATE(NewState));
2698                     ; 1081   if (TIM2_Channel == TIM2_Channel_1)
...
2708                     ; 1086       TIM2->CCER1 |= TIM_CCER1_CC1E ;
2710  02e1 7210525b      	bset	21083,#0
2712  02e5 2014          	jra	L3631
2713  02e7               L7531:
2714                     ; 1090       TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E) ;
...
2723                     ; 1099       TIM2->CCER1 |= TIM_CCER1_CC2E;
2725  02f1 7218525b      	bset	21083,#4
2727  02f5 2004          	jra	L3631
2728  02f7               L5631:
2729                     ; 1103       TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E) ;
2731  02f7 7219525b      	bres	21083,#4
2732  02fb               L3631:
2733                     ; 1106 }
2736  02fb 85            	popw	x
2737  02fc 81            	ret
2901                     ; 1184 void TIM2_ICInit(TIM2_Channel_TypeDef TIM2_Channel,
2901                     ; 1185                  TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
2901                     ; 1186                  TIM2_ICSelection_TypeDef TIM2_ICSelection,
2901                     ; 1187                  TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
2901                     ; 1188                  uint8_t TIM2_ICFilter)
2901                     ; 1189 {
2902                     	switch	.text
2903  02fd               _TIM2_ICInit:
2905  02fd 89            	pushw	x
2906       00000000      OFST:	set	0
2909                     ; 1191   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
2911                     ; 1193   if (TIM2_Channel == TIM2_Channel_1)
2913  02fe 9e            	ld	a,xh
2914  02ff 4d            	tnz	a
2915  0300 2614          	jrne	L5641
2916                     ; 1196     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection, TIM2_ICFilter);
...
2926  030e 84            	pop	a
2927                     ; 1199     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
2929  030f 7b06          	ld	a,(OFST+6,sp)
2930  0311 cd03e3        	call	_TIM2_SetIC1Prescaler
2933  0314 2012          	jra	L7641
2934  0316               L5641:
2935                     ; 1204     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection, TIM2_ICFilter);
...
2945  0322 84            	pop	a
2946                     ; 1207     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
...
2955  0328 85            	popw	x
2956  0329 81            	ret
3052                     ; 1235 void TIM2_PWMIConfig(TIM2_Channel_TypeDef TIM2_Channel,
3052                     ; 1236                      TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
3052                     ; 1237                      TIM2_ICSelection_TypeDef TIM2_ICSelection,
3052                     ; 1238                      TIM2_ICPSC_TypeDef TIM2_ICPrescaler,
3052                     ; 1239                      uint8_t TIM2_ICFilter)
3052                     ; 1240 {
3053                     	switch	.text
...
3061                     ; 1241   uint8_t icpolarity = TIM2_ICPolarity_Rising;
3063                     ; 1242   uint8_t icselection = TIM2_ICSelection_DirectTI;
3065                     ; 1245   assert_param(IS_TIM2_CHANNEL(TIM2_Channel));
3067                     ; 1248   if (TIM2_ICPolarity == TIM2_ICPolarity_Rising)
3069  032c 9f            	ld	a,xl
3070  032d 4d            	tnz	a
3071  032e 2606          	jrne	L7351
3072                     ; 1250     icpolarity = TIM2_ICPolarity_Falling;
3074  0330 a601          	ld	a,#1
3075  0332 6b01          	ld	(OFST-1,sp),a
3077  0334 2002          	jra	L1451
3078  0336               L7351:
3079                     ; 1254     icpolarity = TIM2_ICPolarity_Rising;
3081  0336 0f01          	clr	(OFST-1,sp)
3082  0338               L1451:
3083                     ; 1258   if (TIM2_ICSelection == TIM2_ICSelection_DirectTI)
3085  0338 7b07          	ld	a,(OFST+5,sp)
3086  033a a101          	cp	a,#1
3087  033c 2606          	jrne	L3451
3088                     ; 1260     icselection = TIM2_ICSelection_IndirectTI;
3090  033e a602          	ld	a,#2
3091  0340 6b02          	ld	(OFST+0,sp),a
3093  0342 2004          	jra	L5451
3094  0344               L3451:
3095                     ; 1264     icselection = TIM2_ICSelection_DirectTI;
3097  0344 a601          	ld	a,#1
3098  0346 6b02          	ld	(OFST+0,sp),a
3099  0348               L5451:
3100                     ; 1267   if (TIM2_Channel == TIM2_Channel_1)
3102  0348 0d03          	tnz	(OFST+1,sp)
3103  034a 2626          	jrne	L7451
3104                     ; 1270     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection,
3104                     ; 1271                TIM2_ICFilter);
...
3114  0358 84            	pop	a
3115                     ; 1274     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
3117  0359 7b08          	ld	a,(OFST+6,sp)
3118  035b cd03e3        	call	_TIM2_SetIC1Prescaler
3120                     ; 1277     TI2_Config((TIM2_ICPolarity_TypeDef)icpolarity, (TIM2_ICSelection_TypeDef)icselection, TIM2_ICFilter);
...
3130  036a 84            	pop	a
3131                     ; 1280     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
3133  036b 7b08          	ld	a,(OFST+6,sp)
3134  036d cd03fd        	call	_TIM2_SetIC2Prescaler
3137  0370 2022          	jra	L1551
3138  0372               L7451:
3139                     ; 1285     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection,
3139                     ; 1286                TIM2_ICFilter);
...
3149  037e 84            	pop	a
3150                     ; 1289     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
3152  037f 7b08          	ld	a,(OFST+6,sp)
3153  0381 ad7a          	call	_TIM2_SetIC2Prescaler
3155                     ; 1292     TI1_Config((TIM2_ICPolarity_TypeDef)icpolarity, (TIM2_ICSelection_TypeDef)icselection, TIM2_ICFilter);
...
3165  038f 84            	pop	a
3166                     ; 1295     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
...
3176  0396 81            	ret
3228                     ; 1304 uint16_t TIM2_GetCapture1(void)
3228                     ; 1305 {
3229                     	switch	.text
...
3238                     ; 1309   tmpccr1h = TIM2->CCR1H;
3240  0399 c65261        	ld	a,21089
3241  039c 6b02          	ld	(OFST-2,sp),a
3242                     ; 1310   tmpccr1l = TIM2->CCR1L;
...
3271  03bc 81            	ret
3323                     ; 1323 uint16_t TIM2_GetCapture2(void)
3323                     ; 1324 {
3324                     	switch	.text
...
3422                     ; 1352   assert_param(IS_TIM2_IC_PRESCALER(TIM2_IC1Prescaler));
3424                     ; 1354   tmpccmr1 = TIM2->CCMR1;
...
3433                     ; 1360   tmpccmr1 |= (uint8_t)TIM2_IC1Prescaler;
3435  03f0 7b01          	ld	a,(OFST+0,sp)
3436  03f2 1a02          	or	a,(OFST+1,sp)
3437  03f4 6b01          	ld	(OFST+0,sp),a
3438                     ; 1362   TIM2->CCMR1 = tmpccmr1;
3440  03f6 7b01          	ld	a,(OFST+0,sp)
3441  03f8 c75259        	ld	21081,a
3442                     ; 1363 }
3445  03fb 85            	popw	x
3446  03fc 81            	ret
3491                     ; 1375 void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
3491                     ; 1376 {
3492                     	switch	.text
...
3502                     ; 1380   assert_param(IS_TIM2_IC_PRESCALER(TIM2_IC2Prescaler));
3504                     ; 1382   tmpccmr2 = TIM2->CCMR2;
...
3647  042e 85            	popw	x
3648  042f 81            	ret
3729                     ; 1451 void TIM2_GenerateEvent(TIM2_EventSource_TypeDef TIM2_EventSource)
3729                     ; 1452 {
3730                     	switch	.text
3731  0430               _TIM2_GenerateEvent:
3735                     ; 1454   assert_param(IS_TIM2_EVENT_SOURCE((uint8_t)TIM2_EventSource));
3737                     ; 1457   TIM2->EGR |= (uint8_t)TIM2_EventSource;
3739  0430 ca5258        	or	a,21080
3740  0433 c75258        	ld	21080,a
3741                     ; 1458 }
3744  0436 81            	ret
3883                     ; 1473 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
3883                     ; 1474 {
3884                     	switch	.text
...
3894                     ; 1476   uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
3898                     ; 1479   assert_param(IS_TIM2_GET_FLAG(TIM2_FLAG));
3900                     ; 1481   tim2_flag_l = (uint8_t)(TIM2->SR1 & (uint8_t)(TIM2_FLAG));
3902  0439 9f            	ld	a,xl
3903  043a c45256        	and	a,21078
3904  043d 6b01          	ld	(OFST-1,sp),a
3905                     ; 1482   tim2_flag_h = (uint8_t)(TIM2->SR2 & (uint8_t)((uint16_t)TIM2_FLAG >> 8));
3907  043f c65257        	ld	a,21079
3908  0442 1403          	and	a,(OFST+1,sp)
3909  0444 6b02          	ld	(OFST+0,sp),a
3910                     ; 1484   if ((uint8_t)(tim2_flag_l | tim2_flag_h) != 0)
...
3932  0458 81            	ret
3967                     ; 1506 void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
3967                     ; 1507 {
3968                     	switch	.text
3969  0459               _TIM2_ClearFlag:
3971  0459 89            	pushw	x
3972       00000000      OFST:	set	0
3975                     ; 1509   assert_param(IS_TIM2_CLEAR_FLAG((uint16_t)TIM2_FLAG));
3977                     ; 1511   TIM2->SR1 = (uint8_t)(~(uint8_t)(TIM2_FLAG));
3979  045a 9f            	ld	a,xl
3980  045b 43            	cpl	a
3981  045c c75256        	ld	21078,a
3982                     ; 1512   TIM2->SR2 = (uint8_t)(~(uint8_t)((uint16_t)TIM2_FLAG >> 8));
...
3990  0465 85            	popw	x
3991  0466 81            	ret
4055                     ; 1526 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
4055                     ; 1527 {
4056                     	switch	.text
...
4066                     ; 1530   uint8_t TIM2_itStatus = 0x0, TIM2_itEnable = 0x0;
4070                     ; 1533   assert_param(IS_TIM2_GET_IT(TIM2_IT));
4072                     ; 1535   TIM2_itStatus = (uint8_t)(TIM2->SR1 & (uint8_t)TIM2_IT);
4074  0469 c45256        	and	a,21078
4075  046c 6b01          	ld	(OFST-1,sp),a
4076                     ; 1537   TIM2_itEnable = (uint8_t)(TIM2->IER & (uint8_t)TIM2_IT);
4078  046e c65255        	ld	a,21077
4079  0471 1403          	and	a,(OFST+1,sp)
4080  0473 6b02          	ld	(OFST+0,sp),a
4081                     ; 1539   if ((TIM2_itStatus != (uint8_t)RESET ) && (TIM2_itEnable != (uint8_t)RESET))
...
4105  0489 81            	ret
4141                     ; 1561 void TIM2_ClearITPendingBit(TIM2_IT_TypeDef TIM2_IT)
4141                     ; 1562 {
4142                     	switch	.text
4143  048a               _TIM2_ClearITPendingBit:
4147                     ; 1564   assert_param(IS_TIM2_IT(TIM2_IT));
4149                     ; 1567   TIM2->SR1 = (uint8_t)(~(uint8_t)TIM2_IT);
4151  048a 43            	cpl	a
4152  048b c75256        	ld	21078,a
4153                     ; 1568 }
4156  048e 81            	ret
4229                     ; 1581 void TIM2_DMACmd( TIM2_DMASource_TypeDef TIM2_DMASource, FunctionalState NewState)
4229                     ; 1582 {
4230                     	switch	.text
...
4264  04a6 85            	popw	x
4265  04a7 81            	ret
4300                     ; 1605 void TIM2_SelectCCDMA(FunctionalState NewState)
4300                     ; 1606 {
4301                     	switch	.text
...
4312                     ; 1613     TIM2->CR2 |= TIM_CR2_CCDS;
4314  04ab 72165251      	bset	21073,#3
4316  04af 2004          	jra	L5322
4317  04b1               L3322:
4318                     ; 1618     TIM2->CR2 &= (uint8_t)(~TIM_CR2_CCDS);
4320  04b1 72175251      	bres	21073,#3
4321  04b5               L5322:
4322                     ; 1620 }
4325  04b5 81            	ret
4349                     ; 1644 void TIM2_InternalClockConfig(void)
4349                     ; 1645 {
4350                     	switch	.text
4351  04b6               _TIM2_InternalClockConfig:
4355                     ; 1647   TIM2->SMCR &=  (uint8_t)(~TIM_SMCR_SMS);
4357  04b6 c65252        	ld	a,21074
4358  04b9 a4f8          	and	a,#248
4359  04bb c75252        	ld	21074,a
4360                     ; 1648 }
4363  04be 81            	ret
4452                     ; 1665 void TIM2_TIxExternalClockConfig(TIM2_TIxExternalCLK1Source_TypeDef TIM2_TIxExternalCLKSource,
4452                     ; 1666                                  TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
...
4460                     ; 1670   assert_param(IS_TIM2_TIXCLK_SOURCE(TIM2_TIxExternalCLKSource));
4462                     ; 1671   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
4464                     ; 1672   assert_param(IS_TIM2_IC_FILTER(ICFilter));
4466                     ; 1675   if (TIM2_TIxExternalCLKSource == TIM2_TIxExternalCLK1Source_TI2)
4468  04c0 9e            	ld	a,xh
4469  04c1 a160          	cp	a,#96
4470  04c3 260f          	jrne	L7032
4471                     ; 1677     TI2_Config(TIM2_ICPolarity, TIM2_ICSelection_DirectTI, ICFilter);
...
4483  04d4               L7032:
4484                     ; 1681     TI1_Config(TIM2_ICPolarity, TIM2_ICSelection_DirectTI, ICFilter);
...
4493  04e0 84            	pop	a
4494  04e1               L1132:
4495                     ; 1685   TIM2_SelectInputTrigger((TIM2_TRGSelection_TypeDef)TIM2_TIxExternalCLKSource);
4497  04e1 7b01          	ld	a,(OFST+1,sp)
4498  04e3 ad4b          	call	_TIM2_SelectInputTrigger
4500                     ; 1688   TIM2->SMCR |= (uint8_t)(TIM2_SlaveMode_External1);
...
4508  04ed 85            	popw	x
4509  04ee 81            	ret
4626                     ; 1707 void TIM2_ETRClockMode1Config(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
4626                     ; 1708                               TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
...
4634                     ; 1712   TIM2_ETRConfig(TIM2_ExtTRGPrescaler, TIM2_ExtTRGPolarity, ExtTRGFilter);
...
4668  051c 85            	popw	x
4669  051d 81            	ret
4727                     ; 1739 void TIM2_ETRClockMode2Config(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
4727                     ; 1740                               TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
...
4735                     ; 1744   TIM2_ETRConfig(TIM2_ExtTRGPrescaler, TIM2_ExtTRGPolarity, ExtTRGFilter);
...
4745  0529 84            	pop	a
4746                     ; 1747   TIM2->ETR |= TIM_ETR_ECE ;
4748  052a 721c5253      	bset	21075,#6
4749                     ; 1748 }
4752  052e 85            	popw	x
4753  052f 81            	ret
4869                     ; 1799 void TIM2_SelectInputTrigger(TIM2_TRGSelection_TypeDef TIM2_InputTriggerSource)
4869                     ; 1800 {
4870                     	switch	.text
...
4880                     ; 1804   assert_param(IS_TIM2_TRIGGER_SELECTION(TIM2_InputTriggerSource));
4882                     ; 1806   tmpsmcr = TIM2->SMCR;
...
4891                     ; 1810   tmpsmcr |= (uint8_t)TIM2_InputTriggerSource;
4893  053d 7b01          	ld	a,(OFST+0,sp)
4894  053f 1a02          	or	a,(OFST+1,sp)
4895  0541 6b01          	ld	(OFST+0,sp),a
4896                     ; 1812   TIM2->SMCR = (uint8_t)tmpsmcr;
4898  0543 7b01          	ld	a,(OFST+0,sp)
4899  0545 c75252        	ld	21074,a
4900                     ; 1813 }
4903  0548 85            	popw	x
4904  0549 81            	ret
5003                     ; 1827 void TIM2_SelectOutputTrigger(TIM2_TRGOSource_TypeDef TIM2_TRGOSource)
5003                     ; 1828 {
5004                     	switch	.text
5005  054a               _TIM2_SelectOutputTrigger:
5007  054a 88            	push	a
5008  054b 88            	push	a
5009       00000001      OFST:	set	1
5012                     ; 1829   uint8_t tmpcr2 = 0;
5014                     ; 1832   assert_param(IS_TIM2_TRGO_SOURCE(TIM2_TRGOSource));
5016                     ; 1834   tmpcr2 = TIM2->CR2;
5018  054c c65251        	ld	a,21073
...
5025                     ; 1840   tmpcr2 |=  (uint8_t)TIM2_TRGOSource;
5027  0557 7b01          	ld	a,(OFST+0,sp)
5028  0559 1a02          	or	a,(OFST+1,sp)
5029  055b 6b01          	ld	(OFST+0,sp),a
5030                     ; 1842   TIM2->CR2 = tmpcr2;
5032  055d 7b01          	ld	a,(OFST+0,sp)
5033  055f c75251        	ld	21073,a
5034                     ; 1843 }
5037  0562 85            	popw	x
5038  0563 81            	ret
5121                     ; 1855 void TIM2_SelectSlaveMode(TIM2_SlaveMode_TypeDef TIM2_SlaveMode)
5121                     ; 1856 {
5122                     	switch	.text
5123  0564               _TIM2_SelectSlaveMode:
5125  0564 88            	push	a
5126  0565 88            	push	a
5127       00000001      OFST:	set	1
5130                     ; 1857   uint8_t tmpsmcr = 0;
5132                     ; 1860   assert_param(IS_TIM2_SLAVE_MODE(TIM2_SlaveMode));
5134                     ; 1862   tmpsmcr = TIM2->SMCR;
5136  0566 c65252        	ld	a,21074
...
5143                     ; 1868   tmpsmcr |= (uint8_t)TIM2_SlaveMode;
5145  0571 7b01          	ld	a,(OFST+0,sp)
5146  0573 1a02          	or	a,(OFST+1,sp)
5147  0575 6b01          	ld	(OFST+0,sp),a
5148                     ; 1870   TIM2->SMCR = tmpsmcr;
5150  0577 7b01          	ld	a,(OFST+0,sp)
5151  0579 c75252        	ld	21074,a
5152                     ; 1871 }
5155  057c 85            	popw	x
5156  057d 81            	ret
5192                     ; 1879 void TIM2_SelectMasterSlaveMode(FunctionalState NewState)
5192                     ; 1880 {
5193                     	switch	.text
5194  057e               _TIM2_SelectMasterSlaveMode:
5198                     ; 1882   assert_param(IS_FUNCTIONAL_STATE(NewState));
5200                     ; 1885   if (NewState != DISABLE)
5202  057e 4d            	tnz	a
5203  057f 2706          	jreq	L7752
5204                     ; 1887     TIM2->SMCR |= TIM_SMCR_MSM;
5206  0581 721e5252      	bset	21074,#7
5208  0585 2004          	jra	L1062
5209  0587               L7752:
5210                     ; 1891     TIM2->SMCR &= (uint8_t)(~TIM_SMCR_MSM);
5212  0587 721f5252      	bres	21074,#7
5213  058b               L1062:
5214                     ; 1893 }
5217  058b 81            	ret
5273                     ; 1911 void TIM2_ETRConfig(TIM2_ExtTRGPSC_TypeDef TIM2_ExtTRGPrescaler,
5273                     ; 1912                     TIM2_ExtTRGPolarity_TypeDef TIM2_ExtTRGPolarity,
5273                     ; 1913                     uint8_t ExtTRGFilter)
5273                     ; 1914 {
5274                     	switch	.text
5275  058c               _TIM2_ETRConfig:
5277  058c 89            	pushw	x
5278       00000000      OFST:	set	0
5281                     ; 1916   assert_param(IS_TIM2_EXT_PRESCALER(TIM2_ExtTRGPrescaler));
5283                     ; 1917   assert_param(IS_TIM2_EXT_POLARITY(TIM2_ExtTRGPolarity));
5285                     ; 1918   assert_param(IS_TIM2_EXT_FILTER(ExtTRGFilter));
5287                     ; 1921   TIM2->ETR |= (uint8_t)((uint8_t)((uint8_t)TIM2_ExtTRGPrescaler | (uint8_t)TIM2_ExtTRGPolarity)
5287                     ; 1922                          | (uint8_t)ExtTRGFilter);
5289  058d 9f            	ld	a,xl
5290  058e 1a01          	or	a,(OFST+1,sp)
5291  0590 1a05          	or	a,(OFST+5,sp)
5292  0592 ca5253        	or	a,21075
5293  0595 c75253        	ld	21075,a
5294                     ; 1923 }
5297  0598 85            	popw	x
5298  0599 81            	ret
5411                     ; 1958 void TIM2_EncoderInterfaceConfig(TIM2_EncoderMode_TypeDef TIM2_EncoderMode,
5411                     ; 1959                                  TIM2_ICPolarity_TypeDef TIM2_IC1Polarity,
5411                     ; 1960                                  TIM2_ICPolarity_TypeDef TIM2_IC2Polarity)
5411                     ; 1961 {
5412                     	switch	.text
5413  059a               _TIM2_EncoderInterfaceConfig:
...
5426                     ; 1967   assert_param(IS_TIM2_ENCODER_MODE(TIM2_EncoderMode));
5428                     ; 1968   assert_param(IS_TIM2_IC_POLARITY(TIM2_IC1Polarity));
5430                     ; 1969   assert_param(IS_TIM2_IC_POLARITY(TIM2_IC2Polarity));
5432                     ; 1971   tmpsmcr = TIM2->SMCR;
5434  059d c65252        	ld	a,21074
5435  05a0 6b01          	ld	(OFST-2,sp),a
5436                     ; 1972   tmpccmr1 = TIM2->CCMR1;
5438  05a2 c65259        	ld	a,21081
5439  05a5 6b02          	ld	(OFST-1,sp),a
5440                     ; 1973   tmpccmr2 = TIM2->CCMR2;
5442  05a7 c6525a        	ld	a,21082
...
5449                     ; 1977   tmpsmcr |= (uint8_t)TIM2_EncoderMode;
...
5474                     ; 1986   if (TIM2_IC1Polarity == TIM2_ICPolarity_Falling)
5476  05cf 9f            	ld	a,xl
5477  05d0 a101          	cp	a,#1
5478  05d2 2606          	jrne	L5072
5479                     ; 1988     TIM2->CCER1 |= TIM_CCER1_CC1P ;
5481  05d4 7212525b      	bset	21083,#1
5483  05d8 2004          	jra	L7072
5484  05da               L5072:
5485                     ; 1992     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P) ;
5487  05da 7213525b      	bres	21083,#1
5488  05de               L7072:
5489                     ; 1995   if (TIM2_IC2Polarity == TIM2_ICPolarity_Falling)
5491  05de 7b08          	ld	a,(OFST+5,sp)
5492  05e0 a101          	cp	a,#1
5493  05e2 2606          	jrne	L1172
5494                     ; 1997     TIM2->CCER1 |= TIM_CCER1_CC2P ;
5496  05e4 721a525b      	bset	21083,#5
5498  05e8 2004          	jra	L3172
5499  05ea               L1172:
5500                     ; 2001     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
5502  05ea 721b525b      	bres	21083,#5
5503  05ee               L3172:
5504                     ; 2004   TIM2->SMCR = tmpsmcr;
5506  05ee 7b01          	ld	a,(OFST-2,sp)
5507  05f0 c75252        	ld	21074,a
5508                     ; 2005   TIM2->CCMR1 = tmpccmr1;
5510  05f3 7b02          	ld	a,(OFST-1,sp)
5511  05f5 c75259        	ld	21081,a
5512                     ; 2006   TIM2->CCMR2 = tmpccmr2;
5514  05f8 7b03          	ld	a,(OFST+0,sp)
5515  05fa c7525a        	ld	21082,a
5516                     ; 2007 }
5519  05fd 5b05          	addw	sp,#5
5520  05ff 81            	ret
5556                     ; 2015 void TIM2_SelectHallSensor(FunctionalState NewState)
5556                     ; 2016 {
5557                     	switch	.text
5558  0600               _TIM2_SelectHallSensor:
5562                     ; 2018   assert_param(IS_FUNCTIONAL_STATE(NewState));
5564                     ; 2021   if (NewState != DISABLE)
5566  0600 4d            	tnz	a
5567  0601 2706          	jreq	L3372
5568                     ; 2023     TIM2->CR2 |= TIM_CR2_TI1S;
5570  0603 721e5251      	bset	21073,#7
5572  0607 2004          	jra	L5372
5573  0609               L3372:
5574                     ; 2027     TIM2->CR2 &= (uint8_t)(~TIM_CR2_TI1S);
5576  0609 721f5251      	bres	21073,#7
5577  060d               L5372:
5578                     ; 2029 }
5581  060d 81            	ret
5653                     ; 2050 static void TI1_Config(TIM2_ICPolarity_TypeDef TIM2_ICPolarity, \
5653                     ; 2051                        TIM2_ICSelection_TypeDef TIM2_ICSelection, \
5653                     ; 2052                        uint8_t TIM2_ICFilter)
5653                     ; 2053 {
5654                     	switch	.text
...
5664                     ; 2055   uint8_t tmpicpolarity = TIM2_ICPolarity;
5666  0610 9e            	ld	a,xh
5667  0611 6b01          	ld	(OFST-1,sp),a
5668                     ; 2056   tmpccmr1 = TIM2->CCMR1;
5670  0613 c65259        	ld	a,21081
5671  0616 6b02          	ld	(OFST+0,sp),a
5672                     ; 2059   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
5674                     ; 2060   assert_param(IS_TIM2_IC_SELECTION(TIM2_ICSelection));
5676                     ; 2061   assert_param(IS_TIM2_IC_FILTER(TIM2_ICFilter));
5678                     ; 2064   TIM2->CCER1 &=  (uint8_t)(~TIM_CCER1_CC1E);
5680  0618 7211525b      	bres	21083,#0
...
5686                     ; 2068   tmpccmr1 |= (uint8_t)(((uint8_t)(TIM2_ICSelection)) | ((uint8_t)(TIM2_ICFilter << 4)));
...
5696                     ; 2070   TIM2->CCMR1 = tmpccmr1;
5698  062f 7b02          	ld	a,(OFST+0,sp)
5699  0631 c75259        	ld	21081,a
5700                     ; 2073   if (tmpicpolarity == (uint8_t)(TIM2_ICPolarity_Falling))
5702  0634 7b01          	ld	a,(OFST-1,sp)
5703  0636 a101          	cp	a,#1
5704  0638 2606          	jrne	L5772
5705                     ; 2075     TIM2->CCER1 |= TIM_CCER1_CC1P;
5707  063a 7212525b      	bset	21083,#1
5709  063e 2004          	jra	L7772
5710  0640               L5772:
5711                     ; 2079     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
5713  0640 7213525b      	bres	21083,#1
5714  0644               L7772:
5715                     ; 2083   TIM2->CCER1 |=  TIM_CCER1_CC1E;
5717  0644 7210525b      	bset	21083,#0
5718                     ; 2084 }
5721  0648 5b04          	addw	sp,#4
5722  064a 81            	ret
5794                     ; 2101 static void TI2_Config(TIM2_ICPolarity_TypeDef TIM2_ICPolarity,
5794                     ; 2102                        TIM2_ICSelection_TypeDef TIM2_ICSelection,
5794                     ; 2103                        uint8_t TIM2_ICFilter)
5794                     ; 2104 {
5795                     	switch	.text
...
5805                     ; 2106   uint8_t tmpicpolarity = TIM2_ICPolarity;
5807  064d 9e            	ld	a,xh
5808  064e 6b01          	ld	(OFST-1,sp),a
5809                     ; 2109   assert_param(IS_TIM2_IC_POLARITY(TIM2_ICPolarity));
5811                     ; 2110   assert_param(IS_TIM2_IC_SELECTION(TIM2_ICSelection));
5813                     ; 2111   assert_param(IS_TIM2_IC_FILTER(TIM2_ICFilter));
5815                     ; 2113   tmpccmr2 = TIM2->CCMR2;
5817  0650 c6525a        	ld	a,21082
5818  0653 6b02          	ld	(OFST+0,sp),a
5819                     ; 2116   TIM2->CCER1 &=  (uint8_t)(~TIM_CCER1_CC2E);
5821  0655 7219525b      	bres	21083,#4
...
5827                     ; 2120   tmpccmr2 |= (uint8_t)(((uint8_t)(TIM2_ICSelection)) | ((uint8_t)(TIM2_ICFilter << 4)));
...
5837                     ; 2122   TIM2->CCMR2 = tmpccmr2;
5839  066c 7b02          	ld	a,(OFST+0,sp)
5840  066e c7525a        	ld	21082,a
5841                     ; 2125   if (tmpicpolarity == TIM2_ICPolarity_Falling)
5843  0671 7b01          	ld	a,(OFST-1,sp)
5844  0673 a101          	cp	a,#1
5845  0675 2606          	jrne	L7303
5846                     ; 2127     TIM2->CCER1 |= TIM_CCER1_CC2P ;
5848  0677 721a525b      	bset	21083,#5
5850  067b 2004          	jra	L1403
5851  067d               L7303:
5852                     ; 2131     TIM2->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
5854  067d 721b525b      	bres	21083,#5
5855  0681               L1403:
5856                     ; 2135   TIM2->CCER1 |=  TIM_CCER1_CC2E;
5858  0681 7218525b      	bset	21083,#4
5859                     ; 2136 }
5862  0685 5b04          	addw	sp,#4
5863  0687 81            	ret
5876                     	xdef	_TIM2_SelectHallSensor
5877                     	xdef	_TIM2_EncoderInterfaceConfig
5878                     	xdef	_TIM2_ETRConfig
5879                     	xdef	_TIM2_SelectMasterSlaveMode
5880                     	xdef	_TIM2_SelectSlaveMode
5881                     	xdef	_TIM2_SelectOutputTrigger
5882                     	xdef	_TIM2_SelectInputTrigger
5883                     	xdef	_TIM2_ETRClockMode2Config
5884                     	xdef	_TIM2_ETRClockMode1Config
5885                     	xdef	_TIM2_TIxExternalClockConfig
5886                     	xdef	_TIM2_InternalClockConfig
5887                     	xdef	_TIM2_SelectCCDMA
5888                     	xdef	_TIM2_DMACmd
5889                     	xdef	_TIM2_ClearITPendingBit
5890                     	xdef	_TIM2_GetITStatus
5891                     	xdef	_TIM2_ClearFlag
5892                     	xdef	_TIM2_GetFlagStatus
5893                     	xdef	_TIM2_GenerateEvent
5894                     	xdef	_TIM2_ITConfig
5895                     	xdef	_TIM2_SetIC2Prescaler
5896                     	xdef	_TIM2_SetIC1Prescaler
5897                     	xdef	_TIM2_GetCapture2
5898                     	xdef	_TIM2_GetCapture1
5899                     	xdef	_TIM2_PWMIConfig
5900                     	xdef	_TIM2_ICInit
5901                     	xdef	_TIM2_CCxCmd
5902                     	xdef	_TIM2_OC2PolarityConfig
5903                     	xdef	_TIM2_OC1PolarityConfig
5904                     	xdef	_TIM2_OC2FastConfig
5905                     	xdef	_TIM2_OC1FastConfig
5906                     	xdef	_TIM2_OC2PreloadConfig
5907                     	xdef	_TIM2_OC1PreloadConfig
5908                     	xdef	_TIM2_ForcedOC2Config
5909                     	xdef	_TIM2_ForcedOC1Config
5910                     	xdef	_TIM2_SetCompare2
5911                     	xdef	_TIM2_SetCompare1
5912                     	xdef	_TIM2_SelectOCxM
5913                     	xdef	_TIM2_CtrlPWMOutputs
5914                     	xdef	_TIM2_BKRConfig
5915                     	xdef	_TIM2_OC2Init
5916                     	xdef	_TIM2_OC1Init
5917                     	xdef	_TIM2_Cmd
5918                     	xdef	_TIM2_SelectOnePulseMode
5919                     	xdef	_TIM2_ARRPreloadConfig
5920                     	xdef	_TIM2_UpdateRequestConfig
5921                     	xdef	_TIM2_UpdateDisableConfig
5922                     	xdef	_TIM2_GetPrescaler
5923                     	xdef	_TIM2_GetCounter
5924                     	xdef	_TIM2_SetAutoreload
5925                     	xdef	_TIM2_SetCounter
5926                     	xdef	_TIM2_CounterModeConfig
5927                     	xdef	_TIM2_PrescalerConfig
5928                     	xdef	_TIM2_TimeBaseInit
5929                     	xdef	_TIM2_DeInit
5948                     	end
