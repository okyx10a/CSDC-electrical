...
xlabel('Time [seconds]')
xticks(1:5:length(min_beta_power));
xticklabels(1:length(min_beta_power)/10:length(min_beta_power));
...
xlabel('Time [seconds]')
ylabel('Total Power Generated [W]')
xticks(1:5:length(max_beta_power));
...
xlabel('Time [seconds]')
xticks(1:5:length(avg_beta_power));
ylabel('Total Power Generated [W]')
